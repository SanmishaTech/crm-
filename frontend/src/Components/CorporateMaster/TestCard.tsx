          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Corporate Code..." {...field} />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormDescription>What will be Discount Type?</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>What is your name of Value.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
...
export default function SettingsProfilePage() {
  ...
  return (
    <Card className="min-w-[350px] overflow-auto bg-light shadow-md pt-4 ">
      ...
      <CardHeader>
        <CardTitle>Corporate Master</CardTitle>
        <CardDescription>Add Corporate master</CardDescription>
      </CardHeader>
      <CardContent>
