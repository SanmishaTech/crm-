...
export default function Dashboardholiday() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/api/services/allservices/${User?._id}`)
      .then((response) => {
    ...
    setConfig({
      ...
      tableColumns: {
        title: "Services",
        description: "Manage Services and view their details.",
        headers: [
          { label: "Name", key: "patientName" },
          { label: "Description", key: "gender" },
          { label: "Price", key: "paymentMode" },
          { label: "Duration", key: "phone" },
          { label: "Urgent Duration", key: "patientAge" },
          { label: "Urgent Price", key: "referralName" },
        ],
        // tabs: [
        //   { label: "All", value: "all" },
  ...
  const mappedTableData = data?.map((item) => {
    ...
    return {
      ...
      patientAge: item?.urgentDuration || "Unkown",
      gender: item?.description || "Unknown",
      phone: item?.durationInDays || "Unknown",
      paymentMode: item?.price || "Unknown",
      referralName: item?.urgentPrice || "Unknown",
